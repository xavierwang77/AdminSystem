...
export default {
    ...
    methods: {
        async locateUserAvatar() {
            try {
          const response = await axios.post('http://localhost:8080/locateUserAvatar',this.changeInfo,{
            headers: {
        ...
        async getOriginalAvatarName() {
            try {
                const response = await axios.post('http://localhost:8080/getOriginalAvatarName',this.changeInfo,{
                    headers: {
                        'Content-Type': 'application/json',
                    }
                });
        ...
        async getLoginPrivilege() {
          try {
                const response = await axios.post('http://localhost:8080/getLoginPrivilege',this.changeInfo,{
                    headers: {
                        'Content-Type': 'application/json',
                    }
                });
        ...
        async getOriginalUserData() {
            try {
                const response = await axios.post('http://localhost:8080/getOriginalUserData',this.changeInfo,{
                    headers: {
                        'Content-Type': 'application/json',
                    }
                });
        ...
        try {
          const response = await axios.post('http://localhost:8080/changeData',this.changeForm,{
            headers: {
              'Content-Type': 'application/json',
            }
          });
