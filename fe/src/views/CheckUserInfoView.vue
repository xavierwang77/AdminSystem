...
export default {
    ...
    created() {
        ...
        async locateUserAvatar() {
            try {
          const response = await axios.post('http://localhost:8080/locateUserAvatar',this.checkInfo,{
            headers: {
        ...
        async getOriginalUserData() {
            try {
                const response = await axios.post('http://localhost:8080/getOriginalUserData',this.checkInfo,{
                    headers: {
                        'Content-Type': 'application/json',
                    }
                });
